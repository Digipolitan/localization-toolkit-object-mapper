# Contributing to localization-toolkit-object-mapper
...
* **Did the problem start happening recently** (e.g. after updating to a new version of localization-toolkit-object-mapper) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of localization-toolkit-object-mapper ?** What's the most recent version in which the problem doesn't happen? You can download older versions of localization-toolkit-object-mapper from [the releases page](https://github.com/digipolitan/localization-toolkit-object-mapper/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of localization-toolkit-object-mapper are you using?
...
#### Template For Submitting Bug Reports
    ...
    **localization-toolkit-object-mapper version:** [Enter localization-toolkit-object-mapper version here]
    ...
    * Problem started happening recently, didn't happen in an older version of localization-toolkit-object-mapper: [Yes/No]
